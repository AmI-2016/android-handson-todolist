...
import it.polito.elite.todolist.AsyncClasses.AsyncGetTask;
import it.polito.elite.todolist.AsyncClasses.AsyncUpdateTask;
...
public class TaskDetailsActivity extends AppCompatActivity {
    ...
    public void returnBackgroundMethod(String JSONResponse)
    {
        try {
            //parse the obtained information (in JSON)
            JSONObject taskObj = new JSONObject(JSONResponse);
            JSONObject singleTask = taskObj.getJSONObject("task");

            Task task = new Task();
            task.setDescription(singleTask.getString("description"));
            task.setId(Integer.parseInt(singleTask.getString("id")));
            task.setUrgent(Integer.parseInt(singleTask.getString("urgent")));
